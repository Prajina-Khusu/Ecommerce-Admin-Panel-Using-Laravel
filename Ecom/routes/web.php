...
Route::group(['prefix'=>'admin'],function()
{
    ...
    Route::group(['middleware'=>'admin.auth'],function()
    {
        ...
        Route::delete('/sub-categories/{sub-category}',[SubCategoryController::class,'destroy'])->name('sub-categories.delete');
        ...
        Route::get('/brands/{brand}',[BrandsController::class,'destroy'])->name('brands.delete');
        ...
        Route::get('/product-subcategories',[ProductSubCategoryController::class,'index'])->name('productsubcategory.index');
