					...
					<div class="container-fluid">
                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="short_description" id="short_description" cols="30" rows="10" class="summernote" placeholder="" value="">{{$product->short_description}}</textarea>
                                                </div>
                                            </div>  
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="shipping_returns" id="shipping_returns" cols="30" rows="10" class="summernote" placeholder="" value="">{{$product->shipping_returns}}</textarea>
                                                </div>
                                            </div> 
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">	
                                        <h2 class="h4 mb-3">Related Prodcuts</h2>
                                        <div class="mb-3">
                                           <select multiple class="related-product w-100" name="related_products[]" id="related-products">
