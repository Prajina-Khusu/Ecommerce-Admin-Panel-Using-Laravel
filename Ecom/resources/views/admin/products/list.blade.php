                        ...
                        <form action="" method='get'>
							<div class="card-header">
                                <div class="card-title">
                                    <button type="button" onclick="window.location.href='{{ route("products.index") }}'" class="btn btn-default">Reset</button>
                                </div>
									...
									<tbody>
                                        @if($products->isNotEmpty())
											...
											<td>
                                                ...
                                                @else
                                                <img src="{{asset('admin-assets/img/default.png')}}" class="img-thumbnail" width="50" >
