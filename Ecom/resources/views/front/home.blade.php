        ...
        <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="false">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{asset('front-assets/images/all.jpg')}}" />
                        <source media="(min-width: 800px)" srcset="{{asset('front-assets/images/all.jpg')}}" />
                        <img src="{{asset('front-assets/images/all.jpg')}}" alt="" />
                    </picture>

                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3">
                            <h1 class="display-4 text-white mb-3">Nepali Handicrafts</h1>
                    ...
                    <div class="card product-card">
                        <div class="product-image position-relative">
                            <a href="{{route('front.product',$product->slug)}}" class="product-img">
                                ...
                                @else
                                 <img class="card-img-top" src="{{asset('admin-assets/img/default.png')}}"  >
