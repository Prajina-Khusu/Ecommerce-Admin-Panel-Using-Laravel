	...
	<div class="container">
		<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
			<div class="col-lg-4 logo">
                ...
                <span class="h1 text-uppercase text-primary bg-dark px-2">Samyak</span>
	...
	<div class="container">
		<nav class="navbar navbar-expand-xl" id="navbar">
			<a href="{{route('front.home')}}" class="text-decoration-none mobile-logo">
				<span class="h2 text-uppercase text-primary bg-dark">Samyak</span>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="footer-card">
					<h3>Get In Touch</h3>
					<p>Craft your creativity with us <br>
					Byasi, Bhaktapur , Nepal <br>
					info.samyakgroup@gmail.com <br>
					000 000 0000</p>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-12 mt-3">
					<div class="copy-right text-center">
						<p>© Copyright 2023 Samyak Store. All Rights Reserved</p>
					</div>
				</div>
			</div>
		</div>
