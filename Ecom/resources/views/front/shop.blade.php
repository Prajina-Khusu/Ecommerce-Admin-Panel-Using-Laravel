                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-check mb-2">
                                <input {{(in_array($brand->id,$brandsArray))? 'checked' : '' }}  class="form-check-input brand-label" type="checkbox" value="{{$brand->id}}" id="brand-{{$brand->id}}" name="brand[]" {{(in_array($brand->id,$brandsArray))? 'checked':''}}>
                            ...
                            <div class="d-flex align-items-center justify-content-end mb-4">
                                <div class="ml-2">
                                    <select name="sort" id="sort" class="form-control">
                                        ...
                                        <option value="price_asc" {{ ($sort =='price_asct')? 'selected' :''}}>Price Low</option>
                                    </select>                                   
                                </div>
                            </div>
                        </div>
